              ...
              .map((activity) => (
                ...
                >
                  <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">
                    {activity.dateOfHarvest}
                  </Table.Cell>
                  <Table.Cell>{activity.acresHarvested}</Table.Cell>
                  <Table.Cell>{activity.bagsHarvested}</Table.Cell>
                  <Table.Cell>{activity.weightPerBagHarvested}</Table.Cell>
                  <Table.Cell>{activity.modeOfHarvesting}</Table.Cell>
